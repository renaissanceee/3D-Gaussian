...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from,
             render_H, render_W, load_gaussian):
    first_iter = 0
    ...
    logging.basicConfig(filename=scene.model_path + '/log.txt', level=logging.INFO,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[1000,3000, 7000, 30000])
    ...
    training(lp.extract(args), op.extract(args), pp.extract(args), args.test_iterations, args.save_iterations,
             args.checkpoint_iterations, args.start_checkpoint, args.debug_from, args.render_H, args.render_W, args.load_gaussian)
    # All done
    print("\nTraining complete.")
